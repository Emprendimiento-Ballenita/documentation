...
| US16 | Reservar servicio del guía| | **Como** turista, **quiero** poder reservar un servicio de guía turístico en una fecha y hora específicas, asegurando así mi disponibilidad y la del guía **para** la experiencia de viaje | **ESCENARIO**: Realizar reserva del servicio de un guía
**Dado que** el turista ha encontrado un guía adecuado para su viaje **Cuando** el turista quiera reservar un guía seleccionando una fecha -aun sin estar seguro- **Y** haga clic en “Reservar servicio de guía” **Entonces** se generará una reserva para el servicio con el guía elegido | 05 |
